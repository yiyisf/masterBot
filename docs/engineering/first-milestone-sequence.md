...
6. **Employee Workspace short-lived vertical branches** — private Conversation library and reliable Composer, CMaster-owned Run UI Projection Snapshot/stream, pending governance actions, exact-Version Artifact library, AI Elements presentation, i18n/theme/accessibility, desktop-complete and mobile-core behavior. All sub-slices remain behind `CMASTER_EMPLOYEE_WORKSPACE_ENABLED` until the release gate.
